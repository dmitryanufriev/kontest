...
public class FixedSizeSortedListTest {
  ...
  public void setUp() {
    ...
    for (WordWithFrequency wordWithFrequency : new WordWithFrequency[] { a, b, c, d, e, f, g, h, i,
        j }) {
  ...
  public void wordsWithFrequenciesShouldBeAddedInSortOrder() {
    assertArrayEquals(new WordWithFrequency[] { j, b, c, d, g, e, f, h, i, a },
        sortedList.toArray(new WordWithFrequency[0]));
  }
  ...
  public void sortedListShouldBeFixedSize() {
    ...
    assertArrayEquals(new WordWithFrequency[] { z, j, b, c, d, g, e, f, h, i },
        sortedList.toArray(new WordWithFrequency[0]));
  }
